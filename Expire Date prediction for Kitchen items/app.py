...
app = Flask(__name__)
app.secret_key = os.urandom(24)  # Generating a secret key

# Load the lookup table
lookup_table = joblib.load('product_lookup_table.joblib')

# Function to get the remaining days for a product
def get_remaining_days(product_name):
    return lookup_table.get(product_name, None)

# Function to calculate expiry date and remaining days
